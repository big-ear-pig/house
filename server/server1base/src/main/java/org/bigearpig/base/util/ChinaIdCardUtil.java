...
public class ChinaIdCardUtil {
	...
	public static String getSex(String idCard){
		...
		if (validateIdCard18(card)) {
			return getSexFromCard18(idCard);
		}
		if (validateIdCard15(card)) {
			return getSexFromCard18(conver15CardTo18(card));
		}
		return "不知道";

	}
	public static String getSexFromCard18(String idCard){
		String str17 = idCard.substring(16,17);
		int i17 = Integer.parseInt(str17);
		int i = i17%2;
		if(i==1){
			return "男";
		}else{
	...
	public static LocalDate getBirthday(String idCard){
		...
		if (validateIdCard18(card)) {
			return LocalDate.parse(idCard.substring(6,14),dtf);
		}
		if (validateIdCard15(card)) {
			return LocalDate.parse(Objects.requireNonNull(conver15CardTo18(card)).substring(6,14),dtf);
		}
